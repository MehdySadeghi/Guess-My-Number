...
**Try it here:** https://your-guess-my-number-live-link.com
...
```md
![Guess My Number Game](./screenshots/lower-guess.png)
```
```md
![Guess My Number Game](./screenshots/higher-guess.png)
```
...
```md id="ay2a6u"
![Guess My Number Win](./screenshots/win.png)
```
